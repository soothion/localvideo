<table cellpadding="2" cellspacing="1" width="98%">
  ...
  <tr> 
      <td>jodconverter路径</td>
      <td><input type="text" name="setting[jodconverter]" value="vendor/fire-rain/jodconverter/lib/jodconverter-cli-2.2.2.jar" style='width:310px;' class='input-text'></td>
    </tr>
</table>